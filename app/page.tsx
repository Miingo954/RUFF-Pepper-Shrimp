  ...
  return (
    <main>
      ...
      <section id="top" className="hero">
        <img className="hero-bg" src="/images/pepper-shrimp-hero.png" alt="Whole Jamaican pepper shrimp with heads on in a clear takeout tub beside Black River"/><div className="hero-shade"/>
        <div className="hero-copy"><p className="kicker"><span>From Jamaica to Broward</span></p><h1>Real yaad flavor.<br/><em>RUFF heat.</em></h1><p className="hero-lede">Whole shrimp with the heads on, drenched in our fiery Scotch bonnet blend. Bold, bright, and made the Jamaican way.</p><div className="hero-actions"><a className="primary" href="#order">Order a $20 tub <ShoppingBag size={18}/></a><a className="text-link" href="#story">Meet the flavor <ArrowDown size={17}/></a></div></div>
      ...
      <section className="marquee" aria-label="Product highlights"><div className="marquee-track"><span>HEADS ON <i>✦</i> SHELLS ON <i>✦</i> SCOTCH BONNET <i>✦</i> $20 A TUB <i>✦</i> BROWARD COUNTY <i>✦</i></span><span aria-hidden="true">HEADS ON <i>✦</i> SHELLS ON <i>✦</i> SCOTCH BONNET <i>✦</i> $20 A TUB <i>✦</i> BROWARD COUNTY <i>✦</i></span><span aria-hidden="true">HEADS ON <i>✦</i> SHELLS ON <i>✦</i> SCOTCH BONNET <i>✦</i> $20 A TUB <i>✦</i> BROWARD COUNTY <i>✦</i></span><span aria-hidden="true">HEADS ON <i>✦</i> SHELLS ON <i>✦</i> SCOTCH BONNET <i>✦</i> $20 A TUB <i>✦</i> BROWARD COUNTY <i>✦</i></span></div></section>
      <section id="story" className="story">
        ...
        <div className="story-copy"><p className="eyebrow">Straight from the source</p><h2>Born by the river.<br/><em>Raised with flavor.</em></h2><p className="big-copy">In Jamaica, pepper shrimp is more than a snack. It is roadside laughter, river fresh catch, and a bag of fiery goodness passed through the car window.</p><p>RUFF carries that tradition from the spirit of Black River and Middle Quarters to Broward County. Whole shrimp, heads on, seasoned deep, and never shy with the Scotch bonnet.</p><div className="story-signoff"><img src="/images/ruff-shrimp-logo.png" alt="RUFF shrimp mascot"/><span><b>Michael “Mike” Ferguson</b><small>Founder · fisherman · cook</small></span></div></div>
      </section>
      <section className="founder">
        <div className="founder-photo"><img src="/images/mike-and-jamal.jpg" alt="Michael Ferguson holding his young son"/><span>Ferguson family archive</span></div>
        <div className="founder-copy"><p className="eyebrow">The man behind the flavor</p><h2>Meet Mike.</h2><p className="founder-lede">Fisherman. Cook. Father. The hands behind every RUFF tub.</p><p>Every summer in Jamaica, Mike’s children looked forward to Dunn’s River Falls. But the moment they talked about long after the flight home was stopping for pepper shrimp on the island drive. The shrimp lady, the fire, the flavor. It became the best part of the trip.</p><p>Mike wanted to give his family that same joy without needing a plane ticket. He knew the shortcut recipes online did not taste like the real thing, so he went deeper. He traveled, researched, and learned from people close to the source until he perfected a recipe worthy of the memory.</p><blockquote>Same joy. No plane ticket.</blockquote><div className="founder-mark"><img src="/images/ruff-shrimp-logo.png" alt=""/><span><b>Michael “Mike” Ferguson</b><small>Founder · fisherman · cook</small></span></div></div>
      </section>

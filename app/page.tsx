  ...
  return (
    <main>
      ...
      <section className="founder">
        ...
        <div className="founder-copy"><p className="eyebrow">The man behind the flavor</p><h2>Meet Mike.</h2><p className="founder-lede">Fisherman. Cook. Father. The hands behind every RUFF tub.</p><p>Michael Ferguson built RUFF around the food and fishing traditions he knows by heart. From choosing the catch to balancing the Scotch bonnet heat, Mike brings a lifetime of Jamaican flavor to every tub.</p><div className="founder-mark"><img src="/images/ruff-shrimp-logo.png" alt=""/><span><b>Michael “Mike” Ferguson</b><small>Founder · fisherman · cook</small></span></div></div>
      </section>

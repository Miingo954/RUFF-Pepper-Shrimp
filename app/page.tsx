  ...
  return (
    <main>
      ...
      <section className="founder">
        ...
        <div className="founder-copy"><p className="eyebrow">The man behind the flavor</p><h2>Meet Mike.</h2><p className="founder-lede">Fisherman. Cook. Father. The hands behind every RUFF tub.</p><p>Every summer in Jamaica, Mike’s children looked forward to Dunn’s River Falls—but the moment they talked about long after the flight home was stopping for pepper shrimp on the island drive. The shrimp lady, the fire, the flavor: it became the best part of the trip.</p><p>Mike wanted to give his family that same joy without needing a plane ticket. He knew the shortcut recipes online did not taste like the real thing, so he went deeper—traveling, researching, and learning from people close to the source until he perfected a recipe worthy of the memory.</p><blockquote>Same joy. No plane ticket.</blockquote><div className="founder-mark"><img src="/images/ruff-shrimp-logo.png" alt=""/><span><b>Michael “Mike” Ferguson</b><small>Founder · fisherman · cook</small></span></div></div>
      </section>
